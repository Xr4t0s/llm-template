<template>
  <div class="space-y-8 w-full max-w-3xl">
      ...
      <div class="group relative">
		...
		>
          <div class="flex items-start gap-4">
            ...
            <div class="text-xs font-semibold px-3 py-1 rounded-full shrink-0" :class="store.hasMascot ? 'bg-emerald-500/20 text-emerald-300' : 'bg-white/10 text-white/50'">
    ...
    <div v-if="!store.lore" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-orange-500/10 border border-orange-500/20">
      <svg class="w-5 h-5 text-orange-400 shrink-0" fill="currentColor" viewBox="0 0 20 20">
