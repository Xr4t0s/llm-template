...
<template>
  <div class="relative w-full min-h-screen bg-linear-to-br from-slate-950 via-purple-950 to-slate-950">
            ...
            <div class="space-y-8">
              ...
              <div class="space-y-3">
                <div class="flex items-center gap-3">
                  <div class="w-5 h-5 rounded-full bg-linear-to-r from-indigo-400 to-cyan-400 flex items-center justify-center">
            ...
            <div class="w-full max-w-2xl text-center space-y-12">
              ...
              <div class="space-y-6">
                ...
                <div class="space-y-4">
                  <h1 class="text-5xl sm:text-6xl font-bold text-white leading-tight opacity-0 animate-fade-in" style="animation-delay: 0.1s">
                    Welcome to <span class="bg-linear-to-r from-indigo-400 via-cyan-400 to-emerald-400 bg-clip-text text-transparent">Build Studio</span>
                  </h1>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <button @click="startNewBuild" class="group relative opacity-0 animate-fade-in" style="animation-delay: 0.3s">
                  <div class="absolute inset-0 bg-linear-to-br from-indigo-600/20 to-cyan-500/20 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <div class="relative bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl p-8 space-y-4 group-hover:border-white/30 group-hover:bg-white/10 transition-all duration-300 transform group-hover:scale-105 group-hover:-translate-y-2">
                    <div class="w-16 h-16 rounded-xl bg-linear-to-br from-indigo-500/20 to-cyan-500/20 flex items-center justify-center text-4xl group-hover:scale-125 group-hover:rotate-12 transition-all duration-300">✨</div>
                    <div class="space-y-2 text-left">
                      <h2 class="text-xl font-bold text-white group-hover:text-transparent group-hover:bg-linear-to-r group-hover:from-indigo-400 group-hover:to-cyan-400 group-hover:bg-clip-text transition-all">Create Build</h2>
                ...
                <button @click="viewMyBuilds" class="group relative opacity-0 animate-fade-in" style="animation-delay: 0.4s">
                  <div class="absolute inset-0 bg-linear-to-br from-emerald-600/20 to-cyan-500/20 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <div class="relative bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl p-8 space-y-4 group-hover:border-white/30 group-hover:bg-white/10 transition-all duration-300 transform group-hover:scale-105 group-hover:-translate-y-2">
                    <div class="w-16 h-16 rounded-xl bg-linear-to-br from-emerald-500/20 to-cyan-500/20 flex items-center justify-center text-4xl group-hover:scale-125 group-hover:rotate-12 transition-all duration-300">📦</div>
                    <div class="space-y-2 text-left">
                      <h2 class="text-xl font-bold text-white group-hover:text-transparent group-hover:bg-linear-to-r group-hover:from-emerald-400 group-hover:to-cyan-400 group-hover:bg-clip-text transition-all">View Builds</h2>
